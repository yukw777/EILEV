...
prompt_template = """
Use the given verb and noun to generate a complete sentence using "the camera wearer" as the subject.
...
Verb: stand
Noun:
Sentence: The camera wearer stands.
...
for batch in tqdm(batches):
    prompts = [
        prompt_template % (row["predicted_verb"], row["predicted_noun"])
        for row in batch
    ]
